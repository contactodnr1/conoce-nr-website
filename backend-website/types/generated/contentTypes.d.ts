...
export interface ApiBusinessBusiness extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    acceptsCard: Schema.Attribute.Boolean;
    active: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    area: Schema.Attribute.Relation<'oneToOne', 'api::area.area'>;
    businessModel: Schema.Attribute.Enumeration<['physical', 'online', 'both']>;
    categories: Schema.Attribute.Relation<
      'oneToMany',
      'api::category.category'
    >;
    ...
    gallery: Schema.Attribute.Media<
      ...
      true
    >;
    homeDelivery: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    type: Schema.Attribute.Enumeration<['business', 'service', 'place']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
